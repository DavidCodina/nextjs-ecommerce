...
export const BackgroundImageDemo = () => {
  ...
  return (
    <Fragment>
      <BackgroundImage
        src={teaTime.src} //'https://via.placeholder.com/500'
      ...
      >
        ...
        <pre className='mx-auto w-11/12 rounded-xl border border-neutral-500 bg-white text-xs leading-normal font-normal shadow-lg'>
          <code>{`

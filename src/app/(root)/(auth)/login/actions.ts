...
======================================================================== */
//! Gotcha: logging in on the server, results in the same problem that
//! logging out from the server causes - the client-side session is not updated!
...
export const login = async ({
  ...
  try {
    ...
    // by email. If they don't exist, we throw an error, which then causes singIn() here to throw.
